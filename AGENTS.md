...
- SIEMPRE que el autor pase un nuevo MP3 al repo.
- SIEMPRE antes de subir un track a SoundCloud u otra plataforma (para limpiar el "Generated by Suno" del comment y dejar la firma de Seobryn Music).

**Requisitos:**
- `ffmpeg` instalado (`brew install ffmpeg`).
- El script vive en `scripts/clean-mp3.sh` y es ejecutable.
